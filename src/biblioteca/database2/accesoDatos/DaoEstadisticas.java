       ...
       String[] franja,String[] desde,String[] hasta,String area,String autor,String doc_tipo,String usuario, boolean todos){
        ...
        if(todos){
            sql_descargados="SELECT doc_id as Identificación, documentos."
                    ...
                    + "documentos JOIN usuarios ON usuario_descarga_documento.username=usuarios.username GROUP BY Identificación, Titulo ORDER BY  descargas; ";
            ...
            sql_descargados+="GROUP BY Identificación, Titulo ORDER BY  descargas; ";
        }

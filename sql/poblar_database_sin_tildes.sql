INSERT INTO usuarios(username, nombres,  apellidos, password, pregunta_secreta, respuesta_secreta, vinculo_con_univalle, tipo_usuario, correo_electronico, nivel_escolaridad, genero, fecha_nacimiento, fecha_registro) VALUES ('alevalv', 'Alejandro', 'Valdes Villada', 'root', 'root', 'rootroot', 'Pregrado', '3', 'alejandro.valdes@correounivalle.edu.co', 'Bachiller', 'M', '1992-10-26', '2011-05-05 22:39:43.603');
...
INSERT INTO palabras_clave(nombre, descripcion) VALUES ('bases', 'Relacionado a las conjuntos de informacion');
INSERT INTO tipo_material(tipo_documento, descripcion) VALUES ('Libro','Obra impresa o electronica de mas de 49 paginas');
INSERT INTO documentos(activo, titulo_principal, titulo_secundario, descripcion, idioma, editorial, fecha_publicacion, derechos_autor, tipo_documento, fecha_catalogacion, catalogador)VALUES ('true','Fundamentos de Sistemas de Bases de Datos','www.librosite.net/elmasri','Como crear, modificar y usar aplicaciones y sistemas de bases de datos','Espanol','Pearson','20070720','Copyright','Libro','2011-06-05 22:45:16.562','alevalv');
...
INSERT INTO usuarios(username, nombres,  apellidos, password, pregunta_secreta, respuesta_secreta, vinculo_con_univalle, tipo_usuario, correo_electronico, nivel_escolaridad, genero, fecha_nacimiento, fecha_registro) VALUES ('mariacbr', 'Maria Cristina', 'Bustos Rodriguez', 'root', 'root', 'rootroot', 'Pregrado', '3', 'cristina.bustos@correounivalle.edu.co', 'Bachiller', 'M', '1992-06-16', '2011-04-05 22:47:17.722');
...
INSERT INTO usuarios(username, nombres,  apellidos, password, pregunta_secreta, respuesta_secreta, vinculo_con_univalle, tipo_usuario, correo_electronico, nivel_escolaridad, genero, fecha_nacimiento, fecha_registro) VALUES ('juldarod', 'Julian David', 'Rodriguez', 'juldarod', 'Julda', 'rod', 'Pregrado', '3', 'juldarod10@gmail.com', 'Bachiller', 'M', '1992-10-16', '2011-01-05 22:53:13.347');
...
INSERT INTO palabras_clave(nombre, descripcion) VALUES ('lenguajes', 'Forma de comunicacion');
INSERT INTO documentos(activo, titulo_principal, titulo_secundario, descripcion, idioma, editorial, fecha_publicacion, derechos_autor, tipo_documento, fecha_catalogacion, catalogador)VALUES ('true','Essentials of Programming Languages','Third Edition','Informacion sobre los interpretes de codigo del computador','Ingles','MIT Press','20070723','Todos los derechos reservados','Libro','2011-06-05 23:03:12.437','alevalv');
...
INSERT INTO autor(autor_correo, nombre, apellido, acronimo) VALUES ('joshertelo@univalle.edu.co', 'Jose Hernan', 'Trejos Lopez', 'JHTL');
INSERT INTO documentos(activo, titulo_principal, titulo_secundario, descripcion, idioma, editorial, fecha_publicacion, derechos_autor, tipo_documento, fecha_catalogacion, catalogador)VALUES ('true','Curso de bases de datos','Codigo 951027','Concepto fundamentales -- Conceptualizacion, diseno, implementacion y administracion de bases de datos -- Estudio de bases de datos comerciales','Espanol','Univalle, DINTEV','19960727','GPL','Libro','2011-06-05 23:08:33.102','alevalv');
...
INSERT INTO documentos(activo, titulo_principal, titulo_secundario, descripcion, idioma, editorial, fecha_publicacion, derechos_autor, tipo_documento, fecha_catalogacion, catalogador)VALUES ('true','Analisis y diseno orientado a objetos con UML y el proceso unificado','Introduction to object-oriented analysis and design with UML and the unified process',' Introduccion al UML y el proceso unificado. -- Introduccion a los sistema de informacion. -- Como se desarrollan los sistemas de informacion. -- El paradigma orientado a objetos, UML','Espanol','McGraw-Hill','20050722','Copyright','Libro','2011-06-05 23:20:54.633','alevalv');
...
INSERT INTO documentos(activo, titulo_principal, titulo_secundario, descripcion, idioma, editorial, fecha_publicacion, derechos_autor, tipo_documento, fecha_catalogacion, catalogador)VALUES ('true','La calidad del software como eje matematico de investigacion','AVANCES: Investigacion en Ingenieria ','No. 4, 2006: Investigacion en Ingenieria','Espanol','Universidad Libre','20060120','Copyright','Libro','2011-06-05 23:25:35.213','alevalv');
...
INSERT INTO documentos(activo, titulo_principal, titulo_secundario, descripcion, idioma, editorial, fecha_publicacion, derechos_autor, tipo_documento, fecha_catalogacion, catalogador)VALUES ('true','Construccion de software orientado a objetos','2da Edicion','Computadores; Software; Programacion orientada a objetos;','Espanol','Prentice Hall','19990527','Copyright','Libro','2011-06-05 23:30:42.965','alevalv');
...
INSERT INTO documentos(activo, titulo_principal, titulo_secundario, descripcion, idioma, editorial, fecha_publicacion, derechos_autor, tipo_documento, fecha_catalogacion, catalogador)VALUES ('true','Ingenieria de software','Software Enginering','Conceptos relacionados con el desarrollo del 	Software','Espanol','Addison-Wesley','19880910','Copyright','Libro','2011-06-05 23:49:58.588','alevalv');
...
INSERT INTO autor(autor_correo, nombre, apellido, acronimo) VALUES ('gsga@bibliotecadigital.com', 'Andres', 'Gomes de Silva Garza', 'AGSG');
INSERT INTO palabras_clave(nombre, descripcion) VALUES ('progamacion', 'Accion y efecto de programar');
INSERT INTO documentos(activo, titulo_principal, titulo_secundario, descripcion, idioma, editorial, fecha_publicacion, derechos_autor, tipo_documento, fecha_catalogacion, catalogador)VALUES ('true','Introduccion a la computacion','Introduccion a la computacion','Hardware -- Software -- Datos y algoritmos basicos -- Datos y algoritmos avanzados -- Bases de datos -- Sistemas operativos -- redes de computadoras -- Computacion formal -- Graficas por computadora -- Teoria de la informacion ','Espanol','Cengage Learning Editores','20080910','Copyright','Libro','2011-06-05 23:57:30.926','alevalv');
...
INSERT INTO documento_palabras_clave VALUES ('10','progamacion');

INSERT INTO autor(autor_correo, nombre, apellido, acronimo) VALUES ('miwool@bibliotecadigital.com', 'Michael J.', 'Wooldrifge', 'MJW');
INSERT INTO documentos(activo, titulo_principal, titulo_secundario, descripcion, idioma, editorial, fecha_publicacion, derechos_autor, tipo_documento, fecha_catalogacion, catalogador)VALUES ('true','An introduction to multiagent systems','Una introduccion a un sistema multiagente','ntelligent agents -- Deductive reasoning agents -- Practical reasoning agents -- Reactive and hybrid agents -- Multiagent interactions -- Reaching agreements -- Communication -- Working together -- Methodologies -- Applications -- Logics for multiagent systems','Ingles','Jhon Wiley & Sons','20060615','Copyright','Libro','2011-06-06 00:09:23.693','alevalv');
...
INSERT INTO documento_palabras_clave VALUES ('11','progamacion');
...
INSERT INTO documentos(activo, titulo_principal, titulo_secundario, descripcion, idioma, editorial, fecha_publicacion, derechos_autor, tipo_documento, fecha_catalogacion, catalogador)VALUES ('true','Multi-agent programming','languages, platforms and applications','Software; Desarrollo de software para computadores; Diseno de sistemas;','Ingles','Springer-Verlag','20050220','Copyright','Libro','2011-06-06 00:14:08.092','alevalv');
...
INSERT INTO documento_palabras_clave VALUES ('12','progamacion');
...
INSERT INTO documentos(activo, titulo_principal, titulo_secundario, descripcion, idioma, editorial, fecha_publicacion, derechos_autor, tipo_documento, fecha_catalogacion, catalogador)VALUES ('true','Software engineering: a practitioners approach.','sexta edicion','Software; Ingenieria del software; Medicion de software; Desarrollo de software; Diseno en ingenieria; Programacion (Computadores electronicos);','Ingles','McGraw-Hill','20051121','Copyright','Libro','2011-06-06 00:28:47.387','alevalv');
...
INSERT INTO documento_palabras_clave VALUES ('14','progamacion');

INSERT INTO autor(autor_correo, nombre, apellido, acronimo) VALUES ('martha.millan@correounivalle.edu.co', 'Martha', 'Millan', 'MM');
INSERT INTO documentos(activo, titulo_principal, titulo_secundario, descripcion, idioma, editorial, fecha_publicacion, derechos_autor, tipo_documento, fecha_catalogacion, catalogador)VALUES ('true','Diapositivas Subconsultas','Bases de datos 2011 Univalle','Diapositivas de clase de bases de datos','Espanol','Universidad del Valle','20110407','CreativeCommons v3','Libro','2011-06-06 00:32:33.437','alevalv');
